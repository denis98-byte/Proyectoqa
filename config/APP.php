<?php
	...
	----------*/
	const SERVERURL="http://localhost/PROYECTOQA/";


	/*----------  
	Nombre de la empresa o compañia -  Company or company name
	----------*/
	const COMPANY="ASEGURAMIENTO DE CALIDAD DE SOFTWARE";
	...
	const ADDRESS="6Av. 11-60 zona 1, Ciudad de Guatemala, Guatemala, C.A.";
